...
// backendWG is the backend this tool drives that carries a version worth
// classifying: wireguard-tools (wg). wg-quick ships with it, and ip and
// iptables are not versioned against anything, so none of those is probed.
const backendWG = "wireguard-tools"
